...
if (isset($_POST['buy_now'])) {
    ...
    if (mysqli_num_rows($select_cart) > 0) {
        ...
        echo "
        <script>
            alert('Produk sudakh ada dikeranjang');
                ...
                <div class="product-item">
                    <form method="post" action="">
                        ...
                        <a href="product-details.php"><img
                                    src="assets/images/produk/<?php echo $hasil['gambar']; ?>"></a>
                        <div class="down-content">
                            <a href="product-details.php"><h4><?php echo $hasil['merk']; ?></h4></a>
                            <h6>
                                <small>
                            ...
                            <button type="submit" class="btn btn-danger"  name="buy_now">BUY NOW</button>
                        </div>
                    </form>
                </div>
            </div>
